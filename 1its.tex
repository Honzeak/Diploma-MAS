...
In figure (\ref{whyITS}), there are ITS use cases with a high degree of driver interaction (determined 
...
These use cases should be considered when modeling the ITS simulation framework in the practical part of the 
