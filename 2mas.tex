...
of optimal behavior \cite{Anthony2014}. An example of a reactive agent architecture is the Subsumption architecture.
...
In this section, the ways how agents interact with each other were described, concerning the
