...
namespace NWH.VehiclePhysics
{
    ...
    public class DesktopInputManager : MonoBehaviour
    {
        ...
        /// </summary>
        public enum InputType { Standard, Mouse, MouseSteer,CIIRC }
        ...
        void Update()
        {
            ...
            try
            {
                ...
                else if (inputType==InputType.CIIRC)
                {
                    horizontal =volant.steer/360;
                }
                else
                {
                ...
                {
                    accelerator = (Input.GetAxisRaw("Plyn") - 1) / (-1.5f);
                    brake = (Input.GetAxisRaw("Brzda") - 1) / (-2);
                    vertical = accelerator - brake;
                }
                else
                {
