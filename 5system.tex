...
% re-planning according to changing environmental conditions.  Re-planning will occur when it's
% triggered by one of the \emph{exit state} of the agent's skills. The triggers will happen under the
...
% under which additional steps will get added to ideally achieve a \emph{fail-safe behavior}.
...
% destabilize the system as least as possible. For example, autonomous vehicles perform a
% \emph{minimum risk maneuvre} to come to a standstill on the roadside when the expected driver
...
% \begin{table}[htbp]
%     \centering\begin{tabular}{cccccc}\toprule
%         \multicolumn{6}{c}{Header} \\ \midrule 
%         Proto. version & Message ID & Generation time & & & \\ \midrule
%         \multicolumn{6}{c}{Body} \\ 
%         \multicolumn{6}{c}{Decentralized situation managenement} \\ 
%         Action ID & Data version & Expirity time & Frequency & Reliability & Is Negotiation \\ \midrule
%         \multicolumn{2}{c}{Decentralized situation} \\
%         Situation & Severity &&&&\\ \midrule 
%         \multicolumn{6}{c}{Decentralized situation location} \\ 
%         \multicolumn{3}{c}{Event position} & \multicolumn{3}{c}{Trace location data} \\
%         Latitude & Longitude & Elevation & Trace ID & \multicolumn{2}{c}{Waypoint} \\\bottomrule
%     \end{tabular}
%     \caption{The DENM message specification \cite{Santa2013}}
%     \label{denm-spec-tbl}
% \end{table}
